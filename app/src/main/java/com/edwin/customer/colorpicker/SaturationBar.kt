...
class SaturationBar : View {
    ...
    var onSaturationChangedListener: OnSaturationChangedListener? = null
    ...
    fun setSaturation(saturation: Float) {
        mBarPointerPosition = ((mSatToPosFactor * saturation).roundToInt()
    ...
    var color: Int
        ...
        set(color) {
            ...
            mPicker?.apply {
                setNewCenterColor(mColor)
                if (hasValueBar()) changeValueBarColor(mColor)
                else if (hasOpacityBar()) changeOpacityBarColor(
                    mColor
                )
            }
